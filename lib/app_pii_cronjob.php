...
class app_pii_cronjob extends app_pii_models {
	...
	function __construct() {
		parent::__construct();
		$this->pageCountKey =  get_option(OPICPII_Input_SLUG.'language')."-api-prayer-in-islam-p-count-";
		$this->curncyPageKey =  get_option(OPICPII_Input_SLUG.'language')."-api-prayer-in-islam-curency-page-";
	}
